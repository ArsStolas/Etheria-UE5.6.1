...
public:
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category="Item|Stack", meta=(EditCondition="bStackable", ClampMin="1"))
	int32 maxStack = 10;
	...
	UPROPERTY(EditDefaultsOnly, Instanced, BlueprintReadOnly, Category="Item|Use")
	UItemUseEffect* useEffect = nullptr;

	// If true, Event Dispatcher in Inventory
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category="Item|Use")
	bool bBroadcastUseEventIfNoEffect = true;
};
