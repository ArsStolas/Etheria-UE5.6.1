...
class QUEST_SYSTEM_EDITOR_API SGraphEditorActionMenuQuest : public SBorder
{
public:
	SLATE_BEGIN_ARGS(SGraphEditorActionMenuQuest)
		...
		SLATE_ARGUMENT( UQuestBuilderEdNode*, GraphNode)
	...
	~SGraphEditorActionMenuQuest();

	TSharedRef<SEditableTextBox> GetFilterTextBox();

protected:
	UEdGraph* GraphObj;
	UQuestBuilderEdNode* GraphNode;
