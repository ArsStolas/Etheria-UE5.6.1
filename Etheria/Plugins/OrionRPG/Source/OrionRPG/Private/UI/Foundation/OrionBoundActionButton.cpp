...
#include "UI/Foundation/OrionBoundActionButton.h"

#include "CommonInputSubsystem.h"
#include "CommonInputTypeEnum.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(OrionBoundActionButton)

class UCommonButtonStyle;

void UOrionBoundActionButton::NativeConstruct()
{
...
void UOrionBoundActionButton::HandleInputMethodChanged(ECommonInputType NewInputMethod)
{
