...
#include "UI/Foundation/OrionActionWidget.h"
...
FSlateBrush UOrionActionWidget::GetIcon() const
{
...
UEnhancedInputLocalPlayerSubsystem* UOrionActionWidget::GetEnhancedInputSubsystem() const
{
