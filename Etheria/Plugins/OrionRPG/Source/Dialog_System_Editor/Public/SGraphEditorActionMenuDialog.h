...
class DIALOG_SYSTEM_EDITOR_API SGraphEditorActionMenuDialog : public SBorder
{
public:
	SLATE_BEGIN_ARGS(SGraphEditorActionMenuDialog)
		...
		SLATE_ARGUMENT( UDialogBuilderEdNode*, GraphNode)
	...
	~SGraphEditorActionMenuDialog();

	TSharedRef<SEditableTextBox> GetFilterTextBox();

protected:
	UEdGraph* GraphObj;
	UDialogBuilderEdNode* GraphNode;
