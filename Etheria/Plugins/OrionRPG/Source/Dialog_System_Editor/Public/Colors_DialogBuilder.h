...
namespace DialogBuilderColors
{
	...
	{
		const FLinearColor SubNodeBorder(0.3f, 0.3f, 0.3f, 0.2f);
		const FLinearColor Selector(0.01f, 0.01f, 0.01f);
		...
		const FLinearColor HighlightCurrentNode(1.f, 1.f, 1.f, .7f);
		const FLinearColor HighlightAbortRange(0.0f, 0.22f, 0.4f);
		...
		const FLinearColor DescriptionBorder(1.f, 1.0f, 1.f, 0.2f);
	}
